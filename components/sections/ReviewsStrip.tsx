      ...
      <Container className="py-16 sm:py-20">
        ...
        >
          <ul
            ...
            className="flex items-start gap-6 overflow-x-auto scroll-smooth pb-2 [-ms-overflow-style:none] [scrollbar-width:none] snap-x snap-mandatory focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 motion-reduce:scroll-auto [&::-webkit-scrollbar]:hidden"
            aria-label="Reviews"
          >
            {reviews.map((review) => (
              <li
