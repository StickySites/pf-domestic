...
export function WhatsApp({ className = "" }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M17.47 14.38c-.3-.15-1.77-.87-2.04-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.95 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.89-.79-1.48-1.77-1.66-2.07-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.48s1.07 2.87 1.22 3.07c.15.2 2.1 3.2 5.08 4.48.71.31 1.26.49 1.69.63.71.23 1.36.2 1.87.12.57-.08 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.07-.12-.27-.2-.57-.35ZM12.05 2C6.48 2 2 6.48 2 12.05c0 1.78.46 3.45 1.28 4.92L2 22l5.17-1.26a10 10 0 0 0 4.88 1.24h.01c5.56 0 10.05-4.48 10.05-10.05C22.1 6.48 17.61 2 12.05 2Zm0 18.34h-.01a8.3 8.3 0 0 1-4.22-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.3 8.3 0 0 1-1.27-4.4 8.34 8.34 0 0 1 8.33-8.33 8.34 8.34 0 0 1 8.33 8.33 8.34 8.34 0 0 1-8.35 8.3Z" />
    </svg>
  );
}
